        ...
        <div class="col-md-12">
            <div class="panel">
                ...
                <div class="panel-body">
                    @foreach ($detailProduk as $fndetailProduk)
                        <form class="form-horizontal" method="POST" action="/prosesEditProduk?updateId={{$editIdEncrypt}}" enctype="multipart/form-data" role="form">
                            @csrf
                            <div class="form-group">
                                <label for="inputStandard" class="col-lg-3 control-label">Nama Produk</label>
                                <div class="col-lg-8">
                                    <input type="text" id="inputStandard" class="form-control" placeholder="Masukan nama produk" name="namaProduk" value="{{$fndetailProduk->nama_barang}}">
                                    @error('namaProduk')
                                ...
                                <select name="kategoriProduk" id="" class="form-control">
                                    <option value="">Pilih kategori produk</option>
                                        ...
                                        @foreach (range (0,1) as $i )
                                            @if ($fndetailProduk->kategori==$kategoriProduk[$i])
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-8">
                                    <input class="form-control" id="disabledInput" type="Number" name="harga" placeholder="Masukkan Harga Anda (ex: 52000)" min="0" value="{{$fndetailProduk->harga_produk}}">
                                    @error('harga')
                                        <span class="badge bg-danger">{{$message}}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-8">
                                    <input class="form-control" id="disabledInput" type="Number" name="stok" placeholder="Masukkan Stok Anda (ex: 55)" min="0" value="{{$fndetailProduk->stok}}">
                                    @error('stok')
                                        <span class="badge bg-danger">{{$message}}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <select name="paket" class="form-control" id="">
                                        ...
                                        @foreach (range(0,6) as $i )
                                            @if ($fndetailProduk->paket==$arPaket[$i])
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-8">
                                    <textarea class="form-control textarea-grow" id="textArea1" rows="4" name="keteranganProduk" placeholder="Masukkan Keterangan Produk">{{$fndetailProduk->deskripsi_produk}}</textarea>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-8">
                                    <img src="{{asset('img/'.$fndetailProduk->foto_produk)}}" style="width: 200px" alt="">
